                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="">
                        <form method="post" action="{{ route('income.update', $income->id)}}">
                            ...
                            <input value="{{ old('amount',$income->amount) }}" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500
                            ...
                            <input value="{{ old('date_time',$income->date_time) }}" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-80" id="date_time" type="datetime-local" name="date_time" required="required" autofocus="autofocus" autocomplete="date_time">
