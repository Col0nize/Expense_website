                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="">
                        <form>
                            ...
                            <input readonly value="{{ old('name',$category->name) }}" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-80" id="name" type="text" name="name" required="required" autofocus="autofocus" autocomplete="username">
                            <div class="mt-3 pt-3">
