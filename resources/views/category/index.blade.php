        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="">
                        <a class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded " href="{{ route('category.create') }}">Add categories</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="flex justify-center items-center space-x-2">
                                            ...
                                            <form action="{{ route('category.destroy',$category->id) }}" method="post" onsubmit="return confirm('Are you sure you want to delete this?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit">
                                                <a>
